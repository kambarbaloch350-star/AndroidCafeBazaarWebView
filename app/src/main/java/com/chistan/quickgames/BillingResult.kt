...
data class PurchaseResult(
    ...
    /**
     * True when Poolakey checked the purchase signature against the RSA key
     * from the CafeBazaar console (`SecurityCheck.Enable`), i.e. a forged or
     * replayed receipt could not have produced this result. A WebApp that
     * credits paid goods (coins) must only do so for `verified` purchases.
     */
    ...
    fun toJson(): JSONObject {
        ...
        json.put("verified", success && verified)
